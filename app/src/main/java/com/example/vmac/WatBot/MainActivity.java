  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    private void sendMessage() {
                        ...
                        if (!this.initialRequest) {
                            ...
                            if(inputMessage.getMessage().equals("kemon acho?"))
                            {
    ...
    protected void onStart() {
        ...
        AudioManager mAudioManager = (AudioManager) this.getSystemService(Context.AUDIO_SERVICE); int current_volume =mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
        //If you want to player is mute ,then set_volume variable is zero.Otherwise you may supply some value.
         int set_volume=0; mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC,set_volume, 0);
    }
